...
void Date::setCurrectDate(){
	setDate(localTime.tm_mon + 1, localTime.tm_mday, localTime.tm_year + 1900);
}

int Date::getCurreectDay(){
	return  localTime.tm_mday;
}

int Date::getCurreectMonth(){
	return localTime.tm_mon + 1;
}

int Date::getCurreectYear(){
...
int  Date::firstDayofNewYearAndMonth(int year) {
	int day_start;
	int x1, x2, x3;
	x1 = (year - 1) / 4;
	x2 = (year - 1) / 100;
...
string Date::monthOfYear(int month){
	switch (month)
	{
